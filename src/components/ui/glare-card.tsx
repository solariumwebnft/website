...
export const GlareCard = ({
  ...
  const backgroundStyle = {
    "--step": "10%", // Keep larger step for smoother transitions
    "--foil-svg": `url("data:image/svg+xml,%3Csvg width='26' height='26' viewBox='0 0 26 26' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M2.99994 3.419C2.99994 3.419 21.6142 7.43646 22.7921 12.153C23.97 16.8695 3.41838 23.0306 3.41838 23.0306' stroke='white' stroke-width='2' stroke-miterlimit='3.86874' stroke-linecap='round' style='mix-blend-mode:darken'/%3E%3C/svg%3E")`,
    "--pattern": "var(--foil-svg) center/100% no-repeat",
    "--rainbow":
      "repeating-linear-gradient( 0deg, rgba(255, 119, 115, 0.3) calc(var(--step) * 1), rgba(255, 237, 95, 0.3) calc(var(--step) * 2), rgba(168, 255, 95, 0.3) calc(var(--step) * 3), rgba(131, 255, 247, 0.3) calc(var(--step) * 4), rgba(120, 148, 255, 0.3) calc(var(--step) * 5), rgba(216, 117, 255, 0.3) calc(var(--step) * 6), rgba(255, 119, 115, 0.3) calc(var(--step) * 7) ) 0% var(--bg-y)/200% 700% no-repeat", // Further reduce opacity
    "--diagonal":
      "repeating-linear-gradient( 128deg, #0e152e 0%, hsl(180, 10%, 30%) 4%, hsl(180, 10%, 30%) 5%, hsl(180, 10%, 30%) 6%, #0e152e 10%, #0e152e 12% ) var(--bg-x) var(--bg-y)/300% no-repeat", // Darker tones
    "--shade":
      "radial-gradient( farthest-corner circle at var(--m-x) var(--m-y), rgba(255, 255, 255, 0.02) 15%, rgba(255, 255, 255, 0.05) 30%, rgba(255, 255, 255, 0.07) 150% ) var(--bg-x) var(--bg-y)/300% no-repeat", // Reduce opacity further
  ...
  return (
    <div
      ...
      className="duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] base:h-[400px] relative isolate max-w-full transition-transform will-change-transform [aspect-ratio:17/21] [contain:layout_style] [perspective:600px] md:h-[450px] lg:h-[560px] lg:w-[500px]"
      ref={refElement}
      onPointerMove={(event) => {
